  ...
  return (
    <section className="pt-10 pb-32 px-8 bg-background">
      <div className="m-40 grid grid-cols-4 gap-5 justify-center items-center max-md:grid-cols-1 max-md:m-0 max-2xl:grid-cols-2 max-2xl:m-0">
        <Card className="hover:bg-darkOrange text-white bg-primary cursor-pointer transition-colors	ease-in-out"  onClick={() => router.push('/manualSection')}>
          <CardHeader>
        ...
        <div className="mx-40 flex flex-col">
          ...
          <p className="text-center text-lg max-md:text-base text-text">
