...
function AboutSection() {
  ...
  const card_content = [
    ...
    },
    {
      ...
      description:
        "The Mentoring Validation Form is the document that proves to us that you and your student did the mentoring. We have around 1000 mentorings per month, so in this way, we can validate all mentoring sessions in a reasonable time.",
    },
    {
